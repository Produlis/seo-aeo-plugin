...
```
node "${CLAUDE_PLUGIN_ROOT}/scripts/google-index.js" <url1> [url2] [url3] ...
```
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/google-index.js" https://yourdomain.com/new-article
```

Multiple URLs at once:
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/google-index.js" \
